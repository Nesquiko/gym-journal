...
4. Seated wide neutral grip rows
   - 2 x 12 x 45kg
5. Pushdowns with rope
   - 3 x 12 - 15 x 22.5kg
6. Alternating biceps curls
   - 3 x 10 - 12 per arm x 12.5kg in each hand
7. Ez bar overhand curls
   - working sets: 3 x 15 x 7.5kg per side
8. Stretching
   - straight arms behind head against wall stretch: 3 x 30"
   - bicep stretch: 3 x 15" per arm
...
5. Alternating hammer curls
   - 3 x 6 - 8 per arm x 22.5kg in each hand
6. Incline seated biceps curls
   - 3 x 12 - 15 x 12.5kg
7. Stretching
   - elbow over head stretch: 2 x 30" per arm

...
6. Dumbbell bicep curls
   - 2 x 8 per arm x 17.5kg
7. Dead bug with alternating legs
   - 3 x 8 per leg x 12kg
8. Stretching
...
3. One arm lat pulldowns
   - 2 x 8 per arm x 26kg
4. Belt squats
   - 2 x 8 per leg x 140kg
5. Cable chest flies
   - 2 x 10 x 14kg
6. Stretching
   - chest stretch against wall: 3 x 30" per arm
...
4. Seated calf raises
   - 2 x 10 per leg x 35kg
5. Seated one arm rows
   - 2 x 8 per arm x 20kg
6. Incline bench press
   - My left sholder is doing so good, but I must do something with upper body
   - 2 x 10 x 20kg
7. One arm lat pulldowns
